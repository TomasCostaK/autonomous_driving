...
pointCloudFilenameRecolored = 'LiDAR_PointCloud_Recolored.ply'
pointCloudFilename = 'LiDAR_PointCloud.ply'
numLinesInPlyHeader = 7
labelsFilename = 'LiDAR_PointCloud_labels.txt'
...
plyHeaderLines = pointCloudLines[:numLinesInPlyHeader-1] # do not include the end header for supporting only uncolored point cloud
plyHeaderLines.append('property uchar red')
plyHeaderLines.append('property uchar green')
plyHeaderLines.append('property uchar blue')
plyHeaderLines.append('end_header')
